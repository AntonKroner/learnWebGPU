...
typedef enum WGPUColorWriteMask {
  ...
  WGPUColorWriteMask_All =
    WGPUColorWriteMask_None | WGPUColorWriteMask_Red | WGPUColorWriteMask_Green
...
typedef void (*WGPUAdapterRequestAdapterInfoCallback)(
  struct WGPUAdapterInfo adapterInfo,
...
typedef void (*WGPUAdapterRequestDeviceCallback)(
  ...
  const char* message,
  WGPU_NULLABLE void* userdata) WGPU_FUNCTION_ATTRIBUTE;
typedef void (*WGPUBufferMapAsyncCallback)(
  WGPUBufferMapAsyncStatus status,
  WGPU_NULLABLE void* userdata) WGPU_FUNCTION_ATTRIBUTE;
typedef void (*WGPUDeviceCreateComputePipelineAsyncCallback)(
  WGPUCreatePipelineAsyncStatus status,
  WGPUComputePipeline pipeline,
  const char* message,
  WGPU_NULLABLE void* userdata) WGPU_FUNCTION_ATTRIBUTE;
typedef void (*WGPUDeviceCreateRenderPipelineAsyncCallback)(
  WGPUCreatePipelineAsyncStatus status,
...
typedef void (*WGPUInstanceRequestAdapterCallback)(
  ...
  const char* message,
  WGPU_NULLABLE void* userdata) WGPU_FUNCTION_ATTRIBUTE;
typedef void (*WGPUQueueOnSubmittedWorkDoneCallback)(
...
typedef struct WGPUBufferDescriptor {
    const WGPUChainedStruct* nextInChain;
    WGPU_NULLABLE const char* label;
...
typedef struct WGPUCompilationMessage {
    const WGPUChainedStruct* nextInChain;
    WGPU_NULLABLE const char* message;
...
typedef struct WGPUComputePassDescriptor {
    const WGPUChainedStruct* nextInChain;
    WGPU_NULLABLE const char* label;
    WGPU_NULLABLE const WGPUComputePassTimestampWrites* timestampWrites;
...
typedef struct WGPUProgrammableStageDescriptor {
    ...
    WGPU_NULLABLE const char* entryPoint;
...
typedef struct WGPUColorTargetState {
    const WGPUChainedStruct* nextInChain;
    WGPUTextureFormat format;
    WGPU_NULLABLE const WGPUBlendState* blend;
...
typedef struct WGPUDeviceDescriptor {
    ...
    WGPU_NULLABLE const WGPURequiredLimits* requiredLimits;
...
typedef struct WGPURenderPassDescriptor {
    ...
    WGPU_NULLABLE const WGPURenderPassTimestampWrites* timestampWrites;
...
typedef struct WGPURenderPipelineDescriptor {
    ...
    WGPU_NULLABLE const WGPUDepthStencilState* depthStencil;
    WGPUMultisampleState multisample;
    WGPU_NULLABLE const WGPUFragmentState* fragment;
...
extern "C" {
  ...
  typedef WGPUInstance (*WGPUProcCreateInstance)(
    WGPU_NULLABLE const WGPUInstanceDescriptor* descriptor) WGPU_FUNCTION_ATTRIBUTE;
  ...
  typedef void (*WGPUProcAdapterGetProperties)(
    WGPUAdapter adapter,
  ...
  typedef void (*WGPUProcAdapterRequestAdapterInfo)(
    WGPUAdapter adapter,
    WGPUAdapterRequestAdapterInfoCallback callback,
    WGPU_NULLABLE void* userdata) WGPU_FUNCTION_ATTRIBUTE;
  typedef void (*WGPUProcAdapterRequestDevice)(
    WGPUAdapter adapter,
    WGPU_NULLABLE const WGPUDeviceDescriptor* descriptor,
  ...
  // Procs of BindGroup
  typedef void (*WGPUProcBindGroupSetLabel)(WGPUBindGroup bindGroup, const char* label)
    WGPU_FUNCTION_ATTRIBUTE;
  ...
  typedef const void* (*WGPUProcBufferGetConstMappedRange)(
    WGPUBuffer buffer,
    size_t offset,
  ...
  typedef WGPUBufferUsageFlags (*WGPUProcBufferGetUsage)(WGPUBuffer buffer)
    WGPU_FUNCTION_ATTRIBUTE;
  typedef void (*WGPUProcBufferMapAsync)(
    WGPUBuffer buffer,
    ...
    WGPU_NULLABLE void* userdata) WGPU_FUNCTION_ATTRIBUTE;
  typedef void (*WGPUProcBufferSetLabel)(WGPUBuffer buffer, const char* label)
    WGPU_FUNCTION_ATTRIBUTE;
  ...
  typedef WGPUComputePassEncoder (*WGPUProcCommandEncoderBeginComputePass)(
    ...
    WGPU_NULLABLE const WGPUComputePassDescriptor* descriptor) WGPU_FUNCTION_ATTRIBUTE;
  typedef WGPURenderPassEncoder (*WGPUProcCommandEncoderBeginRenderPass)(
    WGPUCommandEncoder commandEncoder,
    const WGPURenderPassDescriptor* descriptor) WGPU_FUNCTION_ATTRIBUTE;
  ...
  typedef void (*WGPUProcCommandEncoderCopyBufferToTexture)(
    ...
    const WGPUExtent3D* copySize) WGPU_FUNCTION_ATTRIBUTE;
  ...
  typedef WGPUCommandBuffer (*WGPUProcCommandEncoderFinish)(
    WGPUCommandEncoder commandEncoder,
    WGPU_NULLABLE const WGPUCommandBufferDescriptor* descriptor) WGPU_FUNCTION_ATTRIBUTE;
  typedef void (*WGPUProcCommandEncoderInsertDebugMarker)(
    WGPUCommandEncoder commandEncoder,
    const char* markerLabel) WGPU_FUNCTION_ATTRIBUTE;
  ...
  typedef void (*WGPUProcCommandEncoderPushDebugGroup)(
    WGPUCommandEncoder commandEncoder,
    const char* groupLabel) WGPU_FUNCTION_ATTRIBUTE;
  ...
  typedef void (*WGPUProcComputePassEncoderSetBindGroup)(
    ...
    const uint32_t* dynamicOffsets) WGPU_FUNCTION_ATTRIBUTE;
  ...
  typedef WGPUBindGroup (*WGPUProcDeviceCreateBindGroup)(
    WGPUDevice device,
    const WGPUBindGroupDescriptor* descriptor) WGPU_FUNCTION_ATTRIBUTE;
  typedef WGPUBindGroupLayout (*WGPUProcDeviceCreateBindGroupLayout)(
    WGPUDevice device,
    const WGPUBindGroupLayoutDescriptor* descriptor) WGPU_FUNCTION_ATTRIBUTE;
  typedef WGPUBuffer (*WGPUProcDeviceCreateBuffer)(
    WGPUDevice device,
    const WGPUBufferDescriptor* descriptor) WGPU_FUNCTION_ATTRIBUTE;
  typedef WGPUCommandEncoder (*WGPUProcDeviceCreateCommandEncoder)(
    WGPUDevice device,
    WGPU_NULLABLE const WGPUCommandEncoderDescriptor* descriptor) WGPU_FUNCTION_ATTRIBUTE;
  typedef WGPUComputePipeline (*WGPUProcDeviceCreateComputePipeline)(
    WGPUDevice device,
    const WGPUComputePipelineDescriptor* descriptor) WGPU_FUNCTION_ATTRIBUTE;
  ...
  typedef WGPUPipelineLayout (*WGPUProcDeviceCreatePipelineLayout)(
    WGPUDevice device,
    const WGPUPipelineLayoutDescriptor* descriptor) WGPU_FUNCTION_ATTRIBUTE;
  typedef WGPUQuerySet (*WGPUProcDeviceCreateQuerySet)(
    WGPUDevice device,
    const WGPUQuerySetDescriptor* descriptor) WGPU_FUNCTION_ATTRIBUTE;
  typedef WGPURenderBundleEncoder (*WGPUProcDeviceCreateRenderBundleEncoder)(
    WGPUDevice device,
    const WGPURenderBundleEncoderDescriptor* descriptor) WGPU_FUNCTION_ATTRIBUTE;
  typedef WGPURenderPipeline (*WGPUProcDeviceCreateRenderPipeline)(
    WGPUDevice device,
    const WGPURenderPipelineDescriptor* descriptor) WGPU_FUNCTION_ATTRIBUTE;
  ...
  typedef WGPUSampler (*WGPUProcDeviceCreateSampler)(
    WGPUDevice device,
    WGPU_NULLABLE const WGPUSamplerDescriptor* descriptor) WGPU_FUNCTION_ATTRIBUTE;
  typedef WGPUShaderModule (*WGPUProcDeviceCreateShaderModule)(
    WGPUDevice device,
    const WGPUShaderModuleDescriptor* descriptor) WGPU_FUNCTION_ATTRIBUTE;
  typedef WGPUTexture (*WGPUProcDeviceCreateTexture)(
    WGPUDevice device,
    const WGPUTextureDescriptor* descriptor) WGPU_FUNCTION_ATTRIBUTE;
  ...
  typedef void (*WGPUProcDevicePushErrorScope)(WGPUDevice device, WGPUErrorFilter filter)
    WGPU_FUNCTION_ATTRIBUTE;
  typedef void (*WGPUProcDeviceSetLabel)(WGPUDevice device, const char* label)
    WGPU_FUNCTION_ATTRIBUTE;
  ...
  typedef WGPUSurface (*WGPUProcInstanceCreateSurface)(
    ...
    const WGPUSurfaceDescriptor* descriptor) WGPU_FUNCTION_ATTRIBUTE;
  typedef WGPUBool (*WGPUProcInstanceHasWGSLLanguageFeature)(
    WGPUInstance instance,
    WGPUWGSLFeatureName feature) WGPU_FUNCTION_ATTRIBUTE;
  ...
  typedef WGPUQueryType (*WGPUProcQuerySetGetType)(WGPUQuerySet querySet)
    WGPU_FUNCTION_ATTRIBUTE;
  typedef void (*WGPUProcQuerySetSetLabel)(WGPUQuerySet querySet, const char* label)
    WGPU_FUNCTION_ATTRIBUTE;
  ...
  typedef void (*WGPUProcQueueOnSubmittedWorkDone)(
    ...
    WGPU_NULLABLE void* userdata) WGPU_FUNCTION_ATTRIBUTE;
  typedef void (*WGPUProcQueueSetLabel)(WGPUQueue queue, const char* label)
    WGPU_FUNCTION_ATTRIBUTE;
  typedef void (*WGPUProcQueueSubmit)(
    WGPUQueue queue,
    size_t commandCount,
    const WGPUCommandBuffer* commands) WGPU_FUNCTION_ATTRIBUTE;
  typedef void (*WGPUProcQueueWriteBuffer)(
    WGPUQueue queue,
    WGPUBuffer buffer,
  ...
  typedef void (*WGPUProcQueueWriteTexture)(
    ...
    const WGPUExtent3D* writeSize) WGPU_FUNCTION_ATTRIBUTE;
  ...
  typedef WGPURenderBundle (*WGPUProcRenderBundleEncoderFinish)(
    WGPURenderBundleEncoder renderBundleEncoder,
    WGPU_NULLABLE const WGPURenderBundleDescriptor* descriptor) WGPU_FUNCTION_ATTRIBUTE;
  ...
  typedef void (*WGPUProcRenderPassEncoderExecuteBundles)(
    WGPURenderPassEncoder renderPassEncoder,
    size_t bundleCount,
    const WGPURenderBundle* bundles) WGPU_FUNCTION_ATTRIBUTE;
  ...
  typedef void (*WGPUProcRenderPassEncoderSetBlendConstant)(
    WGPURenderPassEncoder renderPassEncoder,
    const WGPUColor* color) WGPU_FUNCTION_ATTRIBUTE;
  ...
  // Procs of Sampler
  typedef void (*WGPUProcSamplerSetLabel)(WGPUSampler sampler, const char* label)
    WGPU_FUNCTION_ATTRIBUTE;
  ...
  // Procs of Surface
  typedef void (*WGPUProcSurfaceConfigure)(
    WGPUSurface surface,
    const WGPUSurfaceConfiguration* config) WGPU_FUNCTION_ATTRIBUTE;
  ...
  typedef void (*WGPUProcSurfaceSetLabel)(WGPUSurface surface, const char* label)
    WGPU_FUNCTION_ATTRIBUTE;
  ...
  typedef WGPUTextureView (*WGPUProcTextureCreateView)(
    WGPUTexture texture,
    WGPU_NULLABLE const WGPUTextureViewDescriptor* descriptor) WGPU_FUNCTION_ATTRIBUTE;
  ...
  typedef void (*WGPUProcTextureSetLabel)(WGPUTexture texture, const char* label)
    WGPU_FUNCTION_ATTRIBUTE;
  ...
  WGPU_EXPORT WGPUBool wgpuAdapterGetLimits(
    WGPUAdapter adapter,
    WGPUSupportedLimits* limits) WGPU_FUNCTION_ATTRIBUTE;
  WGPU_EXPORT void wgpuAdapterGetProperties(
    WGPUAdapter adapter,
    WGPUAdapterProperties* properties) WGPU_FUNCTION_ATTRIBUTE;
  WGPU_EXPORT WGPUBool wgpuAdapterHasFeature(WGPUAdapter adapter, WGPUFeatureName feature)
    WGPU_FUNCTION_ATTRIBUTE;
  WGPU_EXPORT void wgpuAdapterRequestAdapterInfo(
    WGPUAdapter adapter,
    WGPUAdapterRequestAdapterInfoCallback callback,
    WGPU_NULLABLE void* userdata) WGPU_FUNCTION_ATTRIBUTE;
  ...
  WGPU_EXPORT void wgpuBindGroupSetLabel(WGPUBindGroup bindGroup, const char* label)
    WGPU_FUNCTION_ATTRIBUTE;
  ...
  WGPU_EXPORT void wgpuBindGroupLayoutSetLabel(
    WGPUBindGroupLayout bindGroupLayout,
    const char* label) WGPU_FUNCTION_ATTRIBUTE;
  ...
  WGPU_EXPORT const void* wgpuBufferGetConstMappedRange(
    WGPUBuffer buffer,
    size_t offset,
    size_t size) WGPU_FUNCTION_ATTRIBUTE;
  ...
  WGPU_EXPORT WGPUBufferUsageFlags wgpuBufferGetUsage(WGPUBuffer buffer)
    WGPU_FUNCTION_ATTRIBUTE;
  WGPU_EXPORT void wgpuBufferMapAsync(
    WGPUBuffer buffer,
    WGPUMapModeFlags mode,
    size_t offset,
    size_t size,
    WGPUBufferMapAsyncCallback callback,
    WGPU_NULLABLE void* userdata) WGPU_FUNCTION_ATTRIBUTE;
  WGPU_EXPORT void wgpuBufferSetLabel(WGPUBuffer buffer, const char* label)
    WGPU_FUNCTION_ATTRIBUTE;
  ...
  WGPU_EXPORT void wgpuCommandBufferSetLabel(
    WGPUCommandBuffer commandBuffer,
    const char* label) WGPU_FUNCTION_ATTRIBUTE;
  ...
  WGPU_EXPORT WGPURenderPassEncoder wgpuCommandEncoderBeginRenderPass(
    WGPUCommandEncoder commandEncoder,
    const WGPURenderPassDescriptor* descriptor) WGPU_FUNCTION_ATTRIBUTE;
  WGPU_EXPORT void wgpuCommandEncoderClearBuffer(
    WGPUCommandEncoder commandEncoder,
    WGPUBuffer buffer,
    uint64_t offset,
    uint64_t size) WGPU_FUNCTION_ATTRIBUTE;
  ...
  WGPU_EXPORT void wgpuCommandEncoderResolveQuerySet(
    ...
    WGPUBuffer destination,
    uint64_t destinationOffset) WGPU_FUNCTION_ATTRIBUTE;
  WGPU_EXPORT void wgpuCommandEncoderSetLabel(
    WGPUCommandEncoder commandEncoder,
    const char* label) WGPU_FUNCTION_ATTRIBUTE;
  WGPU_EXPORT void wgpuCommandEncoderWriteTimestamp(
    WGPUCommandEncoder commandEncoder,
    WGPUQuerySet querySet,
    uint32_t queryIndex) WGPU_FUNCTION_ATTRIBUTE;
  ...
  WGPU_EXPORT void wgpuComputePassEncoderSetBindGroup(
    ...
    size_t dynamicOffsetCount,
    const uint32_t* dynamicOffsets) WGPU_FUNCTION_ATTRIBUTE;
  WGPU_EXPORT void wgpuComputePassEncoderSetLabel(
    WGPUComputePassEncoder computePassEncoder,
    const char* label) WGPU_FUNCTION_ATTRIBUTE;
  ...
  WGPU_EXPORT WGPUBindGroupLayout wgpuComputePipelineGetBindGroupLayout(
    WGPUComputePipeline computePipeline,
    uint32_t groupIndex) WGPU_FUNCTION_ATTRIBUTE;
  WGPU_EXPORT void wgpuComputePipelineSetLabel(
    WGPUComputePipeline computePipeline,
    const char* label) WGPU_FUNCTION_ATTRIBUTE;
  ...
  WGPU_EXPORT WGPUBool wgpuDeviceHasFeature(WGPUDevice device, WGPUFeatureName feature)
    WGPU_FUNCTION_ATTRIBUTE;
  WGPU_EXPORT void wgpuDevicePopErrorScope(
    WGPUDevice device,
    WGPUErrorCallback callback,
    void* userdata) WGPU_FUNCTION_ATTRIBUTE;
  WGPU_EXPORT void wgpuDevicePushErrorScope(WGPUDevice device, WGPUErrorFilter filter)
    WGPU_FUNCTION_ATTRIBUTE;
  WGPU_EXPORT void wgpuDeviceSetLabel(WGPUDevice device, const char* label)
    WGPU_FUNCTION_ATTRIBUTE;
  WGPU_EXPORT void wgpuDeviceSetUncapturedErrorCallback(
    WGPUDevice device,
    WGPUErrorCallback callback,
    void* userdata) WGPU_FUNCTION_ATTRIBUTE;
  ...
  WGPU_EXPORT WGPUSurface wgpuInstanceCreateSurface(
    WGPUInstance instance,
    const WGPUSurfaceDescriptor* descriptor) WGPU_FUNCTION_ATTRIBUTE;
  WGPU_EXPORT WGPUBool wgpuInstanceHasWGSLLanguageFeature(
    WGPUInstance instance,
    WGPUWGSLFeatureName feature) WGPU_FUNCTION_ATTRIBUTE;
  ...
  WGPU_EXPORT void wgpuPipelineLayoutSetLabel(
    WGPUPipelineLayout pipelineLayout,
    const char* label) WGPU_FUNCTION_ATTRIBUTE;
  ...
  WGPU_EXPORT WGPUQueryType wgpuQuerySetGetType(WGPUQuerySet querySet)
    WGPU_FUNCTION_ATTRIBUTE;
  WGPU_EXPORT void wgpuQuerySetSetLabel(WGPUQuerySet querySet, const char* label)
    WGPU_FUNCTION_ATTRIBUTE;
  ...
  // Methods of Queue
  WGPU_EXPORT void wgpuQueueOnSubmittedWorkDone(
    WGPUQueue queue,
    WGPUQueueOnSubmittedWorkDoneCallback callback,
    WGPU_NULLABLE void* userdata) WGPU_FUNCTION_ATTRIBUTE;
  WGPU_EXPORT void wgpuQueueSetLabel(WGPUQueue queue, const char* label)
    WGPU_FUNCTION_ATTRIBUTE;
  WGPU_EXPORT void wgpuQueueSubmit(
    WGPUQueue queue,
    size_t commandCount,
    const WGPUCommandBuffer* commands) WGPU_FUNCTION_ATTRIBUTE;
  ...
  WGPU_EXPORT void wgpuRenderBundleSetLabel(
    WGPURenderBundle renderBundle,
    const char* label) WGPU_FUNCTION_ATTRIBUTE;
  ...
  WGPU_EXPORT void wgpuRenderBundleEncoderDraw(
    WGPURenderBundleEncoder renderBundleEncoder,
    uint32_t vertexCount,
    uint32_t instanceCount,
    uint32_t firstVertex,
  ...
  WGPU_EXPORT void wgpuRenderBundleEncoderSetIndexBuffer(
    ...
    uint64_t offset,
    uint64_t size) WGPU_FUNCTION_ATTRIBUTE;
  WGPU_EXPORT void wgpuRenderBundleEncoderSetLabel(
    WGPURenderBundleEncoder renderBundleEncoder,
    const char* label) WGPU_FUNCTION_ATTRIBUTE;
  ...
  WGPU_EXPORT void wgpuRenderPassEncoderBeginOcclusionQuery(
    WGPURenderPassEncoder renderPassEncoder,
    uint32_t queryIndex) WGPU_FUNCTION_ATTRIBUTE;
  WGPU_EXPORT void wgpuRenderPassEncoderDraw(
    WGPURenderPassEncoder renderPassEncoder,
    uint32_t vertexCount,
    uint32_t instanceCount,
    uint32_t firstVertex,
  ...
  WGPU_EXPORT void wgpuRenderPassEncoderSetIndexBuffer(
    ...
    uint64_t offset,
    uint64_t size) WGPU_FUNCTION_ATTRIBUTE;
  WGPU_EXPORT void wgpuRenderPassEncoderSetLabel(
    WGPURenderPassEncoder renderPassEncoder,
    const char* label) WGPU_FUNCTION_ATTRIBUTE;
  ...
  WGPU_EXPORT WGPUBindGroupLayout wgpuRenderPipelineGetBindGroupLayout(
    WGPURenderPipeline renderPipeline,
    uint32_t groupIndex) WGPU_FUNCTION_ATTRIBUTE;
  WGPU_EXPORT void wgpuRenderPipelineSetLabel(
    WGPURenderPipeline renderPipeline,
    const char* label) WGPU_FUNCTION_ATTRIBUTE;
  ...
  // Methods of Sampler
  WGPU_EXPORT void wgpuSamplerSetLabel(WGPUSampler sampler, const char* label)
    WGPU_FUNCTION_ATTRIBUTE;
  ...
  WGPU_EXPORT void wgpuShaderModuleGetCompilationInfo(
    ...
    WGPUShaderModuleGetCompilationInfoCallback callback,
    WGPU_NULLABLE void* userdata) WGPU_FUNCTION_ATTRIBUTE;
  WGPU_EXPORT void wgpuShaderModuleSetLabel(
    WGPUShaderModule shaderModule,
    const char* label) WGPU_FUNCTION_ATTRIBUTE;
  ...
  // Methods of Surface
  WGPU_EXPORT void wgpuSurfaceConfigure(
    WGPUSurface surface,
    const WGPUSurfaceConfiguration* config) WGPU_FUNCTION_ATTRIBUTE;
  ...
  WGPU_EXPORT void wgpuSurfaceSetLabel(WGPUSurface surface, const char* label)
    WGPU_FUNCTION_ATTRIBUTE;
  ...
  WGPU_EXPORT void wgpuTextureSetLabel(WGPUTexture texture, const char* label)
    WGPU_FUNCTION_ATTRIBUTE;
  ...
  WGPU_EXPORT void wgpuTextureViewSetLabel(WGPUTextureView textureView, const char* label)
    WGPU_FUNCTION_ATTRIBUTE;
